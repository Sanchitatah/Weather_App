...
// api part
const apiKey = '18b16a4ca9a2813e2042d63910a71765'

form.addEventListener('submit', (event) => {
    event.preventDefault()
    loading.style.display='block';
     
     // when loade the data this blank
    innerData.innerHTML="";
    ...
    weatherData.then((data) => {
        let html =`
            ...
            <div class="weather-icon"><img src=" http://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png" alt="" srcset=""></div>
